...
const ShoppingCartSubmit = (props) => {
...
const mapStateToProps = (state) => {
    return {
        ...
        didUserSubmitCart: state.didUserSubmitCart
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ShoppingCartSubmit);